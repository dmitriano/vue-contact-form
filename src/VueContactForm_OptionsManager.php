...
class VueContactForm_OptionsManager {
    ...
    public function settingsPage() {
        if (!current_user_can('manage_options')) {
            wp_die(__('You do not have sufficient permissions to access this page.', 'vue-contact-form'));
        }
        ...
        ?>
        <div class="wrap">
            <h2><?php _e('System Settings', 'vue-contact-form'); ?></h2>
            <table cellspacing="1" cellpadding="2"><tbody>
            <tr><td><?php _e('System', 'vue-contact-form'); ?></td><td><?php echo php_uname(); ?></td></tr>
            <tr><td><?php _e('PHP Version', 'vue-contact-form'); ?></td>
                <td><?php echo phpversion(); ?>
                <?php
                if (version_compare('5.2', phpversion()) > 0) {
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    _e('(WARNING: This plugin may not work properly with versions earlier than PHP 5.2)', 'vue-contact-form');
                    echo '</span>';
                }
                ?>
                </td>
            </tr>
            <tr><td><?php _e('MySQL Version', 'vue-contact-form'); ?></td>
                <td><?php echo $this->getMySqlVersion() ?>
                    <?php
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    if (version_compare('5.0', $this->getMySqlVersion()) > 0) {
                        _e('(WARNING: This plugin may not work properly with versions earlier than MySQL 5.0)', 'vue-contact-form');
                    }
                    echo '</span>';
                    ?>
                </td>
            ...
            <h2><?php echo $this->getPluginDisplayName(); echo ' '; _e('Settings', 'vue-contact-form'); ?></h2>
            ...
            <?php settings_fields($settingsGroup); ?>
                ...
                <p class="submit">
                    <input type="submit" class="button-primary"
                           value="<?php _e('Save Changes', 'vue-contact-form') ?>"/>
                </p>
            </form>
        </div>
        <?php
    ...
    protected function getOptionValueI18nString($optionValue) {
        switch ($optionValue) {
            case 'true':
                return __('true', 'vue-contact-form');
            case 'false':
                return __('false', 'vue-contact-form');

            case 'Administrator':
                return __('Administrator', 'vue-contact-form');
            case 'Editor':
                return __('Editor', 'vue-contact-form');
            case 'Author':
                return __('Author', 'vue-contact-form');
            case 'Contributor':
                return __('Contributor', 'vue-contact-form');
            case 'Subscriber':
                return __('Subscriber', 'vue-contact-form');
            case 'Anyone':
                return __('Anyone', 'vue-contact-form');
        }
        return $optionValue;
    }
